...
import 'package:vapusuario/global/global_var.dart';
import 'package:vapusuario/methods/common_methods.dart';
import 'package:vapusuario/pages/trips_history_page.dart';
      ...
      if (snap.snapshot.value != null) {
        if ((snap.snapshot.value as Map)["blockStatus"] == "no") {
          ...
          cMethods.displaySnackBar(
              "you are blocked. Contact admin: admin875@gmail.com", context);
        }
      } else {
        FirebaseAuth.instance.signOut();
        Navigator.push(
                    ...
                    Row(
                      ...
                      children: [
                        ClipOval(
                          child: Image.network(
                            photoDriver == ''
                                ? "https://firebasestorage.googleapis.com/v0/b/vaptest-66ecc.appspot.com/o/avatarman.png?alt=media&token=9a3b5d64-2a39-43cb-be0f-0843fb8a8e04"
                                : photoDriver,
                            width: 60,
                            height: 60,
                            fit: BoxFit.cover,
